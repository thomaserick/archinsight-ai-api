...
class AnaliseDiagramaTest {
    ...
    private static final String DESCRICAO = "Análise do diagrama de classes";
    ...
    class ConstrutorSimples {
        ...
        void deveCriarComDatasAutomaticas() {
            var analise = new AnaliseDiagrama(ID, DESCRICAO, ARQUIVO, STATUS);
    ...
    class ConstrutorCompleto {
        ...
        void deveCriarComTodasPropriedades() {
            var analise = new AnaliseDiagrama(ID, DESCRICAO, ARQUIVO, STATUS, DATA_CRIACAO, DATA_ATUALIZACAO);
    ...
    class FalhaNaCriacao {
        ...
        void deveFalharComIdNull() {
            assertThrows(NullPointerException.class,
                    () -> new AnaliseDiagrama(null, DESCRICAO, ARQUIVO, STATUS, DATA_CRIACAO, DATA_ATUALIZACAO));
        }
        ...
        void deveFalharComArquivoNull() {
            assertThrows(NullPointerException.class,
                    () -> new AnaliseDiagrama(ID, DESCRICAO, null, STATUS, DATA_CRIACAO, DATA_ATUALIZACAO));
        }
        ...
        void deveFalharComStatusNull() {
            assertThrows(NullPointerException.class,
                    () -> new AnaliseDiagrama(ID, DESCRICAO, ARQUIVO, null, DATA_CRIACAO, DATA_ATUALIZACAO));
        }
        ...
        void deveFalharComDataCriacaoNull() {
            assertThrows(NullPointerException.class,
                    () -> new AnaliseDiagrama(ID, DESCRICAO, ARQUIVO, STATUS, null, DATA_ATUALIZACAO));
        }
        ...
        void deveFalharComDataAtualizacaoNull() {
            assertThrows(NullPointerException.class,
                    () -> new AnaliseDiagrama(ID, DESCRICAO, ARQUIVO, STATUS, DATA_CRIACAO, null));
        }
        ...
        void deveFalharConstrutorSimplesComIdNull() {
            assertThrows(NullPointerException.class,
                    () -> new AnaliseDiagrama(null, DESCRICAO, ARQUIVO, STATUS));
        }
        ...
        void deveFalharConstrutorSimplesComArquivoNull() {
            assertThrows(NullPointerException.class,
                    () -> new AnaliseDiagrama(ID, DESCRICAO, null, STATUS));
        }
        ...
        void deveFalharConstrutorSimplesComStatusNull() {
            assertThrows(NullPointerException.class,
                    () -> new AnaliseDiagrama(ID, DESCRICAO, ARQUIVO, null));
        }
    }
}
